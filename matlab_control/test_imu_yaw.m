...
eulerid = geometry_msgs_Quaternion('connect','subscriber','coax_euler56','coax_euler56');
...
imu_q = zeros(N/2,1);
imu_r = zeros(N/2,1);
imu_roll = zeros(N/2,1);
imu_pitch = zeros(N/2,1);
imu_yaw = zeros(N/2,1);
...
for i = 1:3
    ...
    euler = geometry_msgs_Quaternion('read',eulerid,1);
end
...
Data.imu_euler = [imu_roll imu_pitch imu_yaw];
