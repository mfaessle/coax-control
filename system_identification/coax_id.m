...
RPY = zeros(size(Data.orientation,2),3);
for i=1:size(Data.orientation,2)
...
y = [Data.position' RPY]; % single measurements must be in rows!
u = Data.inputs' - repmat([0 0 0.0285 0.0921],size(Data.inputs,2),1);
...
FileName      = 'CoaX_grey_box_new'; % File describing the model structure.
